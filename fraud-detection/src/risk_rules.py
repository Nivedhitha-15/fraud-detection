...
def score_transaction(tx: Dict) -> int:
    ...
    # High-risk devices increase score; medium-risk adds a smaller amount.
    if tx["device_risk_score"] >= 70:
        score += 25
    elif tx["device_risk_score"] >= 40:
        score += 10

    # International transactions are a known fraud vector.
    ...
    # High transaction velocity is a strong account-takeover signal.
    ...
    # Prior chargebacks are the strongest indicator of repeat fraud.
